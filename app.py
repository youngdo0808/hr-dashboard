...
# Settings에서 설정한 카테고리/감성 필터 적용 (표시 단계에서만 필터링)
...
if page == "dashboard":
    ...
    render_thinktank_section(thinktank_df, limit=6)

    section_head("📈", "오늘의 HR 시그널", "Today's HR Signals",
                 "카테고리별 언급량과 톤(긍정/부정)으로 계산한 실시간 지표")
...
# ══════════════════════════════════════════════════════════
    ...
    st.markdown(
        ...
        "- **국내 / Domestic**: 매일노동뉴스 · ZDNet Korea · Korea JoongAng Daily · Naver 뉴스 검색 API\n"
